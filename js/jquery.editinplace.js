...
$.fn.editInPlace.defaults = {
	...
	textarea_rows:		2, // integer: set rows attribute of textarea, if field_type is set to textarea. Use CSS if possible though
	textarea_cols:		90, // integer: set cols attribute of textarea, if field_type is set to textarea. Use CSS if possible though
...
$.extend(InlineEditor.prototype, {
	...
	connectOpeningEvents: function() {
		...
		this.dom.parents().children('.edit').children().children('.editLine').bind('click.editInPlace', function(anEvent){ that.openEditor(anEvent);
			});
	},
